...
interface PlaceDetailsSectionFiveProps {
  description: string;
  propertyDescription: string;
}

const PlaceDetailsSectionFive: React.FC<PlaceDetailsSectionFiveProps> = ({
 description,
 propertyDescription
    ...
    <div className="w-9/10 md:w-8/10 lg:w-7/10 flex items-center justify-center flex-col">
      <div className="flex flex-col items-start w-full mt-4">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
          <h3 className="font-bold">About our place</h3>
...
export default PlaceDetailsSectionFive;
