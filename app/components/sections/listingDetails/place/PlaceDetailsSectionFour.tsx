...
interface PlaceDetailsSectionFourProps {
  placeFeatures: string[];
}

const PlaceDetailsSectionFour: React.FC<PlaceDetailsSectionFourProps> = ({
 placeFeatures

}) => {

   const smokersAllowed = placeFeatures.includes("smokers");
   const petsAllowed = placeFeatures.includes("pets");
   const visitorsAllowed = placeFeatures.includes("visitors");
  const studentsAllowed = placeFeatures.includes("students");
  ...
  src: StaticImageData; 
    ...
    const furnishingItems: FurnishingFeature[] = [
      ...
      const isFeatureSelected = (name: string) => placeFeatures?.includes(name);
...
export default PlaceDetailsSectionFour;
