...
interface PersonDetailsSectionTwoProps {
  monthlyRent: number;
  deposit: number;
...
const PersonDetailsSectionTwo: React.FC<PersonDetailsSectionTwoProps> = ({
  monthlyRent,
  deposit,
  billsIncluded,
  monthlyBills,
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-8 mx-4">
      ...
      <div className="flex flex-col justify-start items-center">
        ...
        />
        <div className="text-teal-500 flex items-center justify-center flex-col mb-2">
          <span className="text-sm text-gray-500">Max Roommates</span>
...
export default PersonDetailsSectionTwo;
